    ...
    class Program
    {
        ...
        private static void SetupSqLite()
        {
            ...
            using (connection)
            {
                ...
                connection.Execute(@" create table Car (CarId INTEGER PRIMARY KEY AUTOINCREMENT, Id INTEGER null, Make nvarchar(100) not null, Model nvarchar(100) not null, Color nvarchar(100) not null, AgeInYears int not null) ");
